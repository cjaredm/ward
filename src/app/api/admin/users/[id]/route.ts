...
const Body = z.object({
  ...
  permissions: z
    ...
    .optional()
    // See the note in ../route.ts: turning a section off takes its edit
    // permission with it, wherever the request came from.
    .transform((v) => (v === undefined ? undefined : normalizePermissions(v))),
